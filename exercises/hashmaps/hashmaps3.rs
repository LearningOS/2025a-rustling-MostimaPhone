...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        match scores.get(&team_1_name) {
            Some(Team) => {
                scores.insert(String::from(&team_1_name.to_string()), 
                        Team {goals_scored :team_1_score + scores.get(&team_1_name).unwrap().goals_scored,
        ...
        match scores.get(&team_2_name) {
            Some(Team) => {
                scores.insert(String::from(&team_2_name.to_string()), 
                        Team {goals_scored :team_2_score + scores.get(&team_2_name).unwrap().goals_scored,
